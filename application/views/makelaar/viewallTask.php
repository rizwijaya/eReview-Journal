            ...
            <div class="container">
                ...
                <div class="container-table100">
                    <div class="wrap-table100">
                        <h2 style="color:green">All Task Progress</h2>
                                ...
                                <table>
                                    <thead>
                                        <tr class="row100 head">
                                            ...
                                            <th width="70px" style="text-align: center">Requested To</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="row100 body">
                                                ...
                                                <td width="200px"><a href="<?= base_url() . 'index.php/ApplicationCtl/download/' . $item['id_task']; ?>" target="_blank"><?= $item['file_location']; ?></a></td>
