            ...
            <nav>
              <ul class="nav topnav">
                <li class="dropdown active">
                  <a href="<?= base_url() . 'MakelaarCtl'; ?>">Home</a>
                </li>
                <li class="dropdown">
                  <a href="#">Task</a>
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() . 'makelaarCtl/getViewOnGoingtask'; ?>">Task On Going</a></li>
                    <li><a href="<?php echo base_url() . 'makelaarCtl/getViewCompletedtask'; ?>">Task Completed</a></li>
                    <li><a href="<?php echo base_url() . 'makelaarCtl/getViewallTask'; ?>">All Task Progress</a></li>
                  </ul>
                </li>
                <li>
                <li class="dropdown">
