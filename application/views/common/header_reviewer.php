            ...
            <nav>
              <ul class="nav topnav">
                <li class="dropdown active">
                  <a href="<?php echo base_url() . 'reviewerCtl/index'; ?>">Home</a>
                </li>
                <li class="dropdown">
                  <a href="#">Task</a>
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() . 'reviewerCtl/taskrequest'; ?>">Task Request</a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo base_url() . 'reviewerCtl/deductFund'; ?>">Deduct Fund</a></li>
                  </ul>
                </li>
                <li class="dropdown">
