      ...
      <div class="container">
        ...
        <div class="container-table100">
          <div class="wrap-table100">
            <h2 style="color:green">My Task List</h2>
                ...
                <table>
                  <thead>
                    <tr class="row100 head">
                      ...
                      <th width="200px" style="text-align: center">Article</th>
                      <th width="5px" style="text-align: center">Pages</th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="row100 body">
                        ...
                        <td width="5px" style="text-align: center"><?= $item['page']; ?></td>
                        <td width="70px" style="text-align: center"><?= date("d M Y", strtotime($item['date_created'])); ?></td>
                        <?php if ($item['nama_status'] == "Waiting Payment") : ?>
                          <td width="30px" style="text-align: center"><a href="<?= base_url() . 'index.php/PaymentCtl/AddPayment/' . $item['id_assign'] . '/' . $item['id_task'] ?>">Payout</a></td>
                        <?php elseif ($item['nama_status'] == "Completed") : ?>
                          <td width="30px" style="text-align: center">Completed
                            <a href="<?= base_url() . 'index.php/ApplicationCtl/downloadCompleted/' . $item['id_assign']; ?>">Download</a></td>
                        <?php else : ?>
                          <td width="30px" style="text-align: center"><?= $item['nama_status']; ?></td>
                        <?php endif; ?>
                      </tr>
                  </tbody>
                <?php }  ?>
